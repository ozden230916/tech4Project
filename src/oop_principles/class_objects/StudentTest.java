...
public class StudentTest {
    public static void main(String[] args) {
       ...
       student1.id = 1001;
        ...
        System.out.println(count + " students are from Chicago");
        ...
        /*
        TASK-3
        Count how many students are teenager
        ...
        /*
        TASK-4
        Print all information of each student in seperate line
         */
        studentList.forEach(student -> {System.out.println(student.firstName);
